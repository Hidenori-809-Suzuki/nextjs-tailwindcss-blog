      ...
      <article className="shadow my-4">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
          ...
          <Link href="#" className="text-slate-900 pb-6">
            ...
            Consequuntur dolorem est quos repudiandae ratione alias nostrum
            quibusdam facilis. Accusantium explicabo fugiat, maxime quisquam
            ipsum odio quia accusamus quidem. Optio, soluta.
          </Link>
